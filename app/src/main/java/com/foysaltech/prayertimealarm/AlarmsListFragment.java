...
import com.foysaltech.prayertimealarm.databinding.FragmentAlarmsListBinding;
import com.foysaltech.prayertimealarm.util.OnToggleAlarmListener;
...
public class AlarmsListFragment extends Fragment implements OnToggleAlarmListener {
    ...
    public void onDelete(Alarm alarm) {
        if (alarm.isStarted()) alarm.cancelAlarm(getContext());
