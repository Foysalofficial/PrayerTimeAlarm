...
import com.foysaltech.prayertimealarm.databinding.ActivityRingBinding;
...
public class RingActivity extends AppCompatActivity {
    ...
    private void snoozeAlarm() {
        ...
        if (alarm != null) {
            ...
            alarm = new Alarm(new Random().nextInt(Integer.MAX_VALUE), calendar.get(Calendar.HOUR_OF_DAY), calendar.get(Calendar.MINUTE), "Snooze", true, false, false, false, false, false, false, false, false, RingtoneManager.getActualDefaultRingtoneUri(getBaseContext(), RingtoneManager.TYPE_ALARM).toString(), false);
        }
